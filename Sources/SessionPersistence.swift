...
enum SurfaceResumeApprovalStore {
    ...
    private static let keychainService = "com.kernelalex.zerocmux.surface-resume-approvals"
...
enum SurfaceResumeBindingScriptStore {
    private static let directoryName = "zerocmux-surface-resume"
...
struct SessionBrowserPanelSnapshot: Codable, Sendable {
    ...
    /// True when the surface is a transparent internal zerocmux UI (e.g. the diff
