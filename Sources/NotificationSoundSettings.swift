...
enum NotificationSoundSettings {
    ...
    private static let stagedCustomSoundBaseName = "zerocmux-custom-notification-sound"
    private static let customSoundPreparationQueue = DispatchQueue(
        label: "com.cmuxterm.notification-sound-preparation",
        qos: .utility
    )
    private static let systemSoundBaseName = "zerocmux-system-notification-sound"
