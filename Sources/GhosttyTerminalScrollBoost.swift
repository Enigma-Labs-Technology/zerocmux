...
/// Classifies a terminal scroll event for zerocmux's historical precise-delta boost.
struct GhosttyTerminalScrollBoost {
    ...
    /// Creates a boost classifier from the AppKit scroll attributes zerocmux uses.
    init(
    ...
    /// Whether the event should receive zerocmux's historical 2x precise-delta boost.
