    ...
    enum Action: String, CaseIterable, Identifiable {
        ...
        var defaultShortcut: StoredShortcut {
            ...
            case .newBrowserWorkspace:
                ...
                // without colliding with any zerocmux default or an AppKit-reserved keystroke.
            ...
            case .clearScreenKeepScrollback:
                ...
                // zerocmux, and sits next to the full-clear chord. Rebindable in Settings → Keyboard Shortcuts.
            ...
            case .toggleBrowserFocusMode:
                ...
                // zerocmux owns the shortcut, and it avoids the Ctrl+Cmd+Return global hotkey some
            ...
            case .openDiffViewer:
                ...
                // Cmd+Opt+D, Cmd+Shift+Opt+D). Adding Shift yields a chord that reaches zerocmux while
        ...
        var isSystemWideShortcutAction: Bool {
            switch self {
        ...
        func normalizedRecordedShortcutResult(_ shortcut: StoredShortcut) -> RecordedShortcutResolution {
            ...
            if isSystemWideShortcutAction {
                if shortcut.hasChord || !shortcut.hasPrimaryModifier {
                ...
                if let conflictingAction = KeyboardShortcutSettings.conflictingAction(
                    for: shortcut,
                    excluding: self
                ), !conflictingAction.isSystemWideShortcutAction {
                    return .rejected(.conflictsWithAction(conflictingAction))
                }
            } else if let conflictingAction = KeyboardShortcutSettings.conflictingAction(
                for: shortcut,
                excluding: self
            ) {
                return .rejected(.conflictsWithAction(conflictingAction))
