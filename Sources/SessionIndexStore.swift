...
nonisolated private let sessionIndexLogger = Logger(
    subsystem: Bundle.main.bundleIdentifier ?? "com.kernelalex.zerocmux",
...
final class SessionIndexStore: ObservableObject {
    ...
    nonisolated private static func loadOpenCodeEntries(
        ...
        do {
            guard let madeSnapshot = try OpenCodeDatabaseSnapshot.make(prefix: "zerocmux-opencode-search") else {
                return []
            }
