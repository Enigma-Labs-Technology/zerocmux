    ...
    var detail: String {
        ...
        case .freshInstall:
            return String(
                ...
                defaultValue: "No user Ghostty settings, so zerocmux applies its managed default colors."
            )
        case .userThemePair:
            return String(
...
class GhosttyApp {
    ...
    private func loadCmuxOwnedGhosttyKeybindOverrides(_ config: ghostty_config_t) {
        // zerocmux owns these split, close, and workspace font-size shortcuts through
...
final class GhosttySurfaceScrollView: NSView {
    ...
    /// Hosted Cloud terminal overlays are not installed in zerocmux.
