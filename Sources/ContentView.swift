...
struct ContentView: View {
    ...
    private func configureMainWindowChrome(
        ...
        // Let zerocmux supply the translucent titlebar fills. AppKit's native
            ...
            CommandPaletteCommandContribution(
                ...
                title: constant(
                    String(
                        ...
                        defaultValue: "Make zerocmux the Default Terminal"
                    )
                ),
                subtitle: constant(
...
struct VerticalTabsSidebar: View {
    ...
    private func flushPendingSelectedWorkspaceScroll(
        ...
        // the zerocmux-owned edge in the sidebar layout livelock
        // (https://github.com/kernelalex/zerocmux/issues/2586). No anchor means
    ...
    private func workspaceRows(
        ...
        // https://github.com/kernelalex/zerocmux/issues/2586.
