...
struct ChatSessionDescriptor: Identifiable, Sendable, Equatable, Codable {
    ...
    var kind: ChatSessionKind = .agent
    ...
    static func openable(_ sessions: [ChatSessionDescriptor]) -> [ChatSessionDescriptor] {
    ...
    func withState(_ newState: ChatAgentState) -> ChatSessionDescriptor {
