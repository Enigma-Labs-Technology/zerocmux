...
struct ChatSessionSurfaceIndex<SessionID: Hashable & Sendable>: Sendable {
    ...
    func sessionIDs(surfaceID: String) -> Set<SessionID> {
    ...
    mutating func sessionIDs<Record: Sendable>(
        surfaceID: String,
