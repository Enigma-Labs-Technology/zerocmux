        ...
        case .destinationProfileNotFound(let query):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "No zerocmux browser profile matches '%@'"
                ),
                query
            )
        case .destinationProfileCreationFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to create zerocmux browser profile '%@'"
                ),
                name
            )
        }
        ...
        case .profileNotFound(let query):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "No zerocmux browser profile matches '%@'. Run 'zerocmux browser profiles' to list available profiles."
                ),
                query
            )
        case .ambiguousProfile(let query, let candidates):
            ...
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Multiple zerocmux browser profiles match '%@': %@. Use a profile UUID."
                ),
                query,
                candidateList
            )
        ...
        case .profileRenameFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to rename zerocmux browser profile to '%@'"
                ),
                name
            )
        case .cannotDeleteDefaultProfile:
        ...
        case .profileInUse(let name, let count):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Cannot delete zerocmux browser profile '%@' while %d browser panel(s) are using it"
                ),
                name,
                count
            )
        case .profileDeleteFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to delete zerocmux browser profile '%@'"
                ),
                name
            )
        case .profileClearFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to clear zerocmux browser profile '%@'"
                ),
                name
            )
        }
