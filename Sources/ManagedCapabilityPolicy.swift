...
enum ManagedCloudPolicy {
    // Hosted services are excluded from zerocmux regardless of managed preferences.
    static var isDisabled: Bool { true }
    static var isEnabled: Bool { false }
    static let socketErrorCode = "unavailable"
    static var disabledMessage: String { VMClientUnavailable.message }
}
