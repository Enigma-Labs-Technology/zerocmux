...
private let tabManagerLogger = Logger(subsystem: "com.kernelalex.zerocmux", category: "TabManager")
...
class TabManager: ObservableObject {
    ...
    /// it. Delivery bypasses zerocmux's shortcut/menu/responder layers entirely.
    ///
    ...
    private func runCloseConfirmationAlert(
        ...
        // shared with every other zerocmux dialog via `NSAlert.runCmuxModal`. This
    ...
    /// `zerocmux browser react-grab toggle` CLI command so both share one action path.
