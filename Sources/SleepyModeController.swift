...
/// leaving the Mac running for the zerocmux iOS app — and covers every screen with
/// the animated scene.
///
...
final class SleepyModeController {
    ...
    // zerocmux pattern for such controllers (TerminalController.shared,
    ...
    private func beginPowerAssertions() {
        let reason = "zerocmux Sleepy Mode" as CFString
