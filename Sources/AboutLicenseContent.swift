...
nonisolated struct AboutLicenseContent {
    ...
    init(
        bundle: Bundle,
        repositoryURL: URL = URL(string: "https://github.com/Enigma-Labs-Technology/zerocmux")!
    ) {
        self.bundle = bundle
    ...
    func correspondingSourceURL(
        ...
        if bundleIdentifier == "com.kernelalex.zerocmux", let version = normalized(version) {
