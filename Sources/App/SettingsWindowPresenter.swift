...
struct SettingsWindowPresenter {
    ...
    /// (https://github.com/kernelalex/zerocmux/issues/5770) become attributable
    /// from `log show --predicate 'subsystem == "com.kernelalex.zerocmux" && category == "Settings"'`.
    private nonisolated static let log = Logger(subsystem: "com.kernelalex.zerocmux", category: "Settings")
    ...
    private func performFocus(_ window: NSWindow) {
        ...
        // https://github.com/kernelalex/zerocmux/issues/5081). One-time front
