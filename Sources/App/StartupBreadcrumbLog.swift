...
enum StartupBreadcrumbLog {
    ...
    private nonisolated static let logger = Logger(subsystem: "com.kernelalex.zerocmux", category: "StartupBreadcrumbLog")
    ...
    static func append(_ event: String, fields: [String: String] = [:]) {
        ...
        do {
            ...
            logger.fault("zerocmux startup breadcrumb failed: \(String(describing: error), privacy: .public)")
        }
    }
    ...
    private static var isEnabled: Bool {
        ...
        return bundleIdentifier == "com.kernelalex.zerocmux.nightly"
            || bundleIdentifier.hasPrefix("com.kernelalex.zerocmux.nightly.")
    ...
    private static var logURL: URL {
        let logsDirectory = FileManager.default.urls(for: .libraryDirectory, in: .userDomainMask)
            .first?
            .appendingPathComponent("Logs/zerocmux", isDirectory: true)
            ?? URL(fileURLWithPath: NSTemporaryDirectory(), isDirectory: true)
                .appendingPathComponent("zerocmux-logs", isDirectory: true)
