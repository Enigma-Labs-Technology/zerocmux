...
/// from `zerocmux window default-display`.
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text(String(
                ...
                defaultValue: "New DEBUG zerocmux windows open on the selected display. Shared across all tagged dev builds; applied at window creation."
            ))
