...
# the controller that assigns it). A literal-only regex never sees such
# constant-backed identifiers, so the lint would pass while Cmd+W fell
# through to the terminal's Close Tab.
