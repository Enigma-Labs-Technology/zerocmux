#!/usr/bin/env python3
"""Check zerocmux-owned Swift warnings against a checked-in budget."""
...
def write_budget(path: pathlib.Path, budget: WarningBudget) -> None:
    ...
    with path.open("w", encoding="utf-8") as handle:
        handle.write("# zerocmux-owned Swift warning budget.\n")
...
def main(argv: list[str]) -> int:
    ...
    print_budget_summary("Actual zerocmux-owned Swift warnings", actual)
