...
DEBUG_CLI = os.path.join(REPO_ROOT, "scripts", "zerocmux-debug-cli.sh")
...
def mac_visible_lines(workspace_id: str, terminal_id: str, lines: int = 45):
    """The Mac side via `zerocmux read-screen`, the canonical CLI used by
...
def send_input(text: str):
    # Use the zerocmux debug CLI to send raw input to the selected terminal.
