...
Apply this rule to zerocmux browser socket automation commands in `Sources/TerminalController.swift` and `Packages/macOS/CmuxControlSocket/Sources/CmuxControlSocket/Wire/ControlCommandExecutionPolicy.swift`.
