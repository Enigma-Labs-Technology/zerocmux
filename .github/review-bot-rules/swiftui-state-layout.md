...
- `ObservableObject`, `@Published`, `@StateObject`, or `@EnvironmentObject` for new zerocmux-owned SwiftUI state where `@Observable` plus `@State` or value snapshots are the modern shape.
