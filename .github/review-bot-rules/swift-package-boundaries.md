...
- Reusable domain logic used by more than one surface (Mac app, CLI, daemon, tests, previews, debug tooling, future shared code) without a small SwiftPM package target.
