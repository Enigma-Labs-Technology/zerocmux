...
/// Locates the built `zerocmux-sidebar-interpreter` worker executable so the client
...
func interpreterWorkerURL() -> URL {
    builtExecutableURL(named: "zerocmux-sidebar-interpreter")
}

/// Locates the built `zerocmux-sidebar-render-fixture` protocol fixture for the
/// `RenderWorkerClient` supervision tests (same lookup rules as the worker).
func renderFixtureURL() -> URL {
    builtExecutableURL(named: "zerocmux-sidebar-render-fixture")
}
