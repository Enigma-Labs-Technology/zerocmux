...
/// Adds zerocmux-owned font scaling modifiers to SwiftUI views.
public extension View {
    /// Injects the global font magnification percent into this view subtree.
    ///
    /// Apply this once near each zerocmux-owned SwiftUI root. Descendant
    ...
    ///
    /// - Parameters:
    ///   - style: The SwiftUI text style whose zerocmux base metrics should be used.
    ///   - weight: An optional weight override. When `nil`, zerocmux uses the style's default weight.
    ///   - design: The system font design to apply.
    ///   - monospacedDigit: Whether numeric glyphs should use tabular widths.
