...
/// Reads and writes zerocmux's numeric Ghostty config settings (sidebar and
...
public struct CmuxGhosttyConfigSettingEditor {
    ...
    /// The smallest sidebar font size zerocmux allows.
    public static let minSidebarFontSize = 10.0
    /// The largest sidebar font size zerocmux allows.
    ...
    /// The smallest surface-tab-bar font size zerocmux allows.
    public static let minSurfaceTabBarFontSize = 8.0
    /// The largest surface-tab-bar font size zerocmux allows.
