...
@Suite struct SentryScrubberTests {
    ...
    @Test func redactsAnyUsersPathEvenWhenNotTheRuntimeHome() {
        ...
        #expect(
            scrubber.scrub("/Users/buildbot/work/zerocmux/Sources/AppDelegate.swift")
                == "/Users/<redacted>/work/zerocmux/Sources/AppDelegate.swift"
        )
    }

    @Test func redactsLinuxHomePaths() {
        #expect(
            scrubber.scrub("at /home/runner/zerocmux/main.swift line 12")
                == "at /home/<redacted>/zerocmux/main.swift line 12"
        )
    }
    ...
    @Test func leavesSystemPathsUntouched() {
        let input = "/usr/lib/foo /System/Library/bar /Applications/zerocmux.app"
