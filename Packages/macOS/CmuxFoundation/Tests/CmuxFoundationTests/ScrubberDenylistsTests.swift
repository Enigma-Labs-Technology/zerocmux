...
@Suite struct ScrubberDenylistsTests {
    ...
    static let sensitiveKeys: [String] = [
        ...
        "_xsrf", "XSRF-TOKEN",
        // PII (zerocmux runs sendDefaultPii = false)
    ...
    /// representative secrets/PII (relay `@common` corpora plus zerocmux's own); each
    ...
    static let valueRedactions: [(input: String, expected: String)] = [
        ...
        // @urlauth equivalent (zerocmux redactURLCredentials) — userinfo stripped.
        ...
        // zerocmux-original provider key / JWT / AWS (exceed relay).
    ...
    /// inversion: relay redacts group 1 = body, zerocmux redacts the whole match).
    ...
    static let preservedStrings: [String] = [
        // UUIDs zerocmux logs constantly (workspace/surface ids). @uuid intentionally not ported.
        ...
        "zerocmux DEV build 1234567890 v2",
