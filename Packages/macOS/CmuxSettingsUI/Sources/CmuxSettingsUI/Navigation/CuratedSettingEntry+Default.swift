...
extension Array where Element == CuratedSettingEntry {
    /// The zerocmux-shipped curated search entries.
    ///
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "supported-file-previews", title: String(localized: "settings.app.openSupportedFilesInCmux", defaultValue: "Open Supported Files in zerocmux"), synonyms: "Open Supported Files in zerocmux app.openSupportedFilesInCmux cmd click file preview pdf image video audio quicklook quick look editor external"),
            .init(section: .app, id: "markdown-viewer", title: String(localized: "settings.app.openMarkdownInCmuxViewer", defaultValue: "Open Markdown in zerocmux Viewer"), synonyms: "Open Markdown in zerocmux Viewer app.openMarkdownInCmuxViewer md markdown mdx viewer preview readme"),
            ...
            .init(
                ...
                detailText: [
                    String(localized: "settings.terminal.memoryGuardrail.subtitleOn", defaultValue: "zerocmux warns you with a badge and a banner when one pane's process tree uses too much memory, so a single leak can't crash the whole app."),
            ...
            .init(section: .sidebarAppearance, id: "open-pr-links", title: String(localized: "settings.app.openSidebarPRLinks", defaultValue: "Open Sidebar PR Links in zerocmux Browser"), synonyms: "Open Sidebar PR Links in zerocmux Browser sidebar.openPullRequestLinksInCmuxBrowser pr links github browser default external embedded"),
            .init(section: .sidebarAppearance, id: "open-port-links", title: String(localized: "settings.app.openSidebarPortLinks", defaultValue: "Open Sidebar Port Links in zerocmux Browser"), synonyms: "Open Sidebar Port Links in zerocmux Browser sidebar.openPortLinksInCmuxBrowser ports localhost links browser default external embedded"),
            ...
            // Browser
            .init(section: .browser, id: "enable-browser", title: String(localized: "settings.browser.enabled", defaultValue: "Enable zerocmux Browser"), synonyms: "Enable zerocmux Browser browser.disabled enable disable webview embedded browser tabs links"),
            ...
            .init(section: .browser, id: "terminal-links", title: String(localized: "settings.browser.openTerminalLinks", defaultValue: "Open Terminal Links in zerocmux Browser"), synonyms: "Open Terminal Links in zerocmux Browser browser.openTerminalLinksInCmuxBrowser click url terminal links open in browser href"),
            ...
            .init(
                ...
                synonyms: [
                    "shortcuts.bindings hotkeys keybindings key bindings commands keyboard accelerators chords zerocmux json open diff viewer changes review git unstaged split left split right split up split down new pane new split move surface move tab focus pane resize pane close tab close workspace next previous select workspace",
            ...
            .init(section: .keyboardShortcuts, id: "shortcut-chords", title: String(localized: "settings.shortcuts.chords", defaultValue: "Shortcut Chords"), synonyms: "Shortcut Chords tmux prefix ctrl-b control-b multi key sequence chord zerocmux json"),
            ...
            // cmux.json
            .init(section: .settingsJSON, id: "open-file", title: String(localized: "settings.settingsJSON.file", defaultValue: "User config file"), synonyms: "User config file open config file json jsonc config editor ~/.config zerocmux preferences"),
            .init(section: .settingsJSON, id: "documentation", title: String(localized: "settings.settingsJSON.documentation", defaultValue: "Documentation"), synonyms: "Documentation docs documentation schema reference zerocmux json keys configuration"),
