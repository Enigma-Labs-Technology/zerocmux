...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "markdown-viewer", title: "Open Markdown in zerocmux Viewer", synonyms: "app.openMarkdownInCmuxViewer md markdown mdx viewer preview readme"),
            ...
            .init(section: .sidebarAppearance, id: "open-pr-links", title: "Open Sidebar PR Links in zerocmux Browser", synonyms: "sidebar.openPullRequestLinksInCmuxBrowser pr links github browser default external embedded"),
            .init(section: .sidebarAppearance, id: "open-port-links", title: "Open Sidebar Port Links in zerocmux Browser", synonyms: "sidebar.openPortLinksInCmuxBrowser ports localhost links browser default external embedded"),
            ...
            // Browser
            .init(section: .browser, id: "enable-browser", title: "Enable zerocmux Browser", synonyms: "browser.disabled enable disable webview embedded browser tabs links"),
            ...
            .init(section: .browser, id: "terminal-links", title: "Open Terminal Links in zerocmux Browser", synonyms: "browser.openTerminalLinksInCmuxBrowser click url terminal links open in browser href"),
            ...
            .init(section: .keyboardShortcuts, id: "shortcut-chords", title: "Shortcut Chords", synonyms: "tmux prefix ctrl-b control-b multi key sequence chord zerocmux json"),
            ...
            // cmux.json
            .init(section: .settingsJSON, id: "open-file", title: "User config file", synonyms: "open config file json jsonc config editor ~/.config zerocmux preferences"),
            .init(section: .settingsJSON, id: "documentation", title: "Documentation", synonyms: "docs documentation schema reference zerocmux json keys configuration"),
