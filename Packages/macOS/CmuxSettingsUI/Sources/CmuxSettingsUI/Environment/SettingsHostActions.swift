...
public protocol SettingsHostActions: AnyObject {
    ...
    /// Opens the zerocmux JSON config file in the user's preferred
    ...
    /// Opens System Settings to the zerocmux notifications pane so the
    /// user can grant / revoke OS-level notification permission.
    func openSystemNotificationSettings()

    /// Restarts the zerocmux app. Used after the user changes the
    ...
    /// Opens the zerocmux terminal config preview window (the legacy
