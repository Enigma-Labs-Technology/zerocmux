        ...
        SettingsCard {
            ...
            SettingsCardRow(
                ...
                subtitle: scrollBar.current
                    ? String(localized: "settings.terminal.scrollBar.subtitleOn", defaultValue: "Shows the right-edge terminal scroll bar in shell scrollback. zerocmux hides it automatically for alternate-screen style TUI surfaces.")
            ...
            SettingsCardRow(
                ...
                subtitle: copyOnSelect.current
                    ...
                    : String(localized: "settings.terminal.copyOnSelect.subtitleOff", defaultValue: "zerocmux does not add system-clipboard copy on selection. Ghostty config still controls Paste Selection.")
            ) {
            ...
            SettingsCardRow(
                ...
                subtitle: hibernation.current
                    ...
                    : String(localized: "settings.terminal.agentHibernation.subtitleOff", defaultValue: "Scheduled hibernation is off. During critical memory pressure, zerocmux may still hibernate safe idle background agents.")
            ) {
