...
nonisolated private let logger = Logger(subsystem: "com.kernelalex.zerocmux", category: "MultiWindowRouter")

/// Runs the bundled zerocmux CLI against the app's control socket to route a
...
public struct MultiWindowRouter: MultiWindowRouting, Sendable {
    ...
    /// - Parameters:
    ///   - cliURL: The bundled zerocmux CLI executable.
