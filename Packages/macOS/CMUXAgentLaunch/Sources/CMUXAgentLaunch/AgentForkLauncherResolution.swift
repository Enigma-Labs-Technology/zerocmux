/// The result of resolving a zerocmux wrapper launcher to its fork command.
public enum AgentForkLauncherResolution: Sendable, Equatable {
    /// The launcher is a zerocmux wrapper; the associated value is its fork argv, or `nil` when
