...
///
/// zerocmux's CLI agent launchers (the `claude-teams` / `oh-my-codex` / `codex-teams` family) run inside a
...
/// (https://github.com/kernelalex/zerocmux/issues/4920, the codex "jumble after reload" symptom).
///
...
public struct AgentSpawnIdentity: Sendable, Equatable {
    ...
    /// for launches that have no own identity (e.g. started outside a zerocmux-managed terminal). Inputs are
