...
/// zerocmux launch wrappers and therefore leaks to every descendant process: an agent
...
public enum AgentLaunchCaptureTrust {
    ...
    /// and the zerocmux app executable, from becoming persisted resume commands.
