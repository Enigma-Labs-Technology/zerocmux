...
struct RovoDevSessionResolverTests {
    ...
    func rejectsMissingAndNonExactCwd() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-rovo-resolver-\(UUID().uuidString)", isDirectory: true)
    ...
    func infersNewestMatchingWorkspaceSession() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-rovo-resolver-newest-\(UUID().uuidString)", isDirectory: true)
    ...
    func matchesSymlinkedWorkspacePaths() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-rovo-resolver-symlink-\(UUID().uuidString)", isDirectory: true)
