...
struct DSLAction: Codable, Equatable, Sendable {
    ...
    /// - any other `type` is treated as a zerocmux dispatcher method
    ///   (``ActionCommand/zerocmux(method:params:)`` with no params).
    var buttonAction: ButtonAction {
        ...
        default:
            return ButtonAction(commands: [.zerocmux(method: type, params: [:])])
        }
    }
}
