...
struct CustomSidebarValidationTests {
    ...
    private func temporaryDirectory() throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-sidebar-validation-\(UUID().uuidString)", isDirectory: true)
    ...
    private static let richSidebarContext: [String: SwiftValue] = [
        ...
        "selectedTitle": .string("zerocmux"),
        "selectedId": .string("workspace-zerocmux"),
        "unreadTotal": .int(4),
        "clock": .object([
        ...
        "workspaces": .array([
            .object([
                "id": .string("workspace-zerocmux"),
                "title": .string("zerocmux"),
                "selected": .bool(true),
                "pinned": .bool(true),
                "index": .int(0),
                "directory": .string("/Users/me/src/zerocmux"),
                ...
                "pr": .object([
                    ...
                    "url": .string("https://github.com/kernelalex/zerocmux/pull/5812"),
                    "status": .string("open"),
                    "stale": .bool(false),
                    "branch": .string("fix-crash-on-launch"),
                ]),
                ...
                "tabs": .array([
                    ...
                    .object([
                        ...
                        "focused": .bool(false),
                        "pinned": .bool(true),
                        "directory": .string("/Users/me/src/zerocmux/web"),
                        "branch": .string("fix-crash-on-launch"),
                        "dirty": .bool(false),
            ...
            .object([
                ...
                "pr": .object([
                    ...
                    "url": .string("https://github.com/kernelalex/zerocmux/pull/5801"),
