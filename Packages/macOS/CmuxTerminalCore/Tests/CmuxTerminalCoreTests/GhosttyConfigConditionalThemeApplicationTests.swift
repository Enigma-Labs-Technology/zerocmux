...
/// Regression coverage for https://github.com/kernelalex/zerocmux/issues/6411.
///
/// zerocmux paints the terminal background from its host layer
...
/// cross-side fell back to the other appearance's theme, zerocmux painted a light
...
@Suite struct GhosttyConfigConditionalThemeApplicationTests {
    ...
    private func makeThemesRoot() throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-6411-\(UUID().uuidString)", isDirectory: true)
