...
/// resolves to the zerocmux wrapper; both paths are exported to the shell as
...
public struct TerminalSurfaceClaudeCommandShim: Equatable, Sendable {
    ...
    /// directory, if the bundled `zerocmux-codex-wrapper` was available. Carried
    ...
    /// zerocmux hooks. `nil` when the codex wrapper was absent.
