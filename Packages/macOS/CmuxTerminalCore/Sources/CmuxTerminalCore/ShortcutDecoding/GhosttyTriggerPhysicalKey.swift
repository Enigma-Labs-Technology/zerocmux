...
/// keys zerocmux maps to a menu-style shortcut glyph.
///
...
/// package without importing GhosttyKit. Any Ghostty physical key zerocmux does not
...
public enum GhosttyTriggerPhysicalKey: String, Sendable, Equatable, Hashable, CaseIterable {
    ...
    /// The menu-style glyph zerocmux renders for this physical key.
    ///
