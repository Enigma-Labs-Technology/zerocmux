...
/// resolves themes by light/dark color scheme, and can fold in zerocmux's managed
...
public struct GhosttyConfig {
    ...
    /// config file, theme, or optional zerocmux managed appearance is parsed.
    public init() {}
    ...
    public struct UserAppearanceConfigSummary {
        ...
        /// Whether the config is eligible for zerocmux's managed default
