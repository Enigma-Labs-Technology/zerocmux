...
/// Regression coverage for https://github.com/kernelalex/zerocmux/issues/6292: tagged DEV and
...
@Suite struct DevStagingUpdateGatingTests {
    ...
    @Test func classifiesDebugAndStagingBundlesAsDevLike() {
        #expect(UpdateController.isDevLikeBundleIdentifier("com.kernelalex.zerocmux.debug"))
        #expect(UpdateController.isDevLikeBundleIdentifier("com.kernelalex.zerocmux.debug.my-tag"))
        #expect(UpdateController.isDevLikeBundleIdentifier("com.kernelalex.zerocmux.staging"))
        #expect(UpdateController.isDevLikeBundleIdentifier("com.kernelalex.zerocmux.staging.my-tag"))
    }

    @Test func doesNotClassifyPublicOrNightlyOrNilAsDevLike() {
        #expect(!UpdateController.isDevLikeBundleIdentifier("com.kernelalex.zerocmux"))
        ...
        #expect(!UpdateController.isDevLikeBundleIdentifier("com.kernelalex.zerocmux.debugger"))
        #expect(!UpdateController.isDevLikeBundleIdentifier("com.kernelalex.zerocmux.stagingx"))
    }
    ...
    private func makeAppcastItem(version: String) -> SUAppcastItem? {
        let enclosure: [String: Any] = [
            "url": "https://example.com/zerocmux.zip",
            "length": "1024",
            "sparkle:version": version,
            "sparkle:shortVersionString": version,
        ]
        let dictionary: [String: Any] = [
            "title": "zerocmux \(version)",
