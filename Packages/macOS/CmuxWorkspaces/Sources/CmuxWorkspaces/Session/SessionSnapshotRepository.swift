...
/// pair under `Application Support/zerocmux/`, and the unusable-primary recovery
...
public struct SessionSnapshotRepository<SnapshotValue: SessionSnapshotRepresenting>: SessionSnapshotStoring {
    ...
    ///     composition root). Falls back to `com.kernelalex.zerocmux` when nil or
    ///     blank.
    ...
    public func syncManualRestoreSnapshotCache() {
        ...
        case .unusable:
            ...
            // sessions (startup fallback and `zerocmux restore-session`).
            break
        }
    }
