...
/// scope and domain filters, any zerocmux profiles created, and the per-mapping
/// outcome entries.
public struct BrowserImportOutcome: Sendable {
    ...
    /// Display names of zerocmux profiles created during this import.
    ...
    ///   - createdDestinationProfileNames: Names of zerocmux profiles created.
    ...
    /// JSON-serializable representation sent over the zerocmux automation socket.
