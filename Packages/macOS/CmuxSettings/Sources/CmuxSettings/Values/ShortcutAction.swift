...
/// The stable, user-customisable shortcut actions zerocmux exposes. Each case is a
...
extension ShortcutAction {
    ...
    ///
    /// Most zerocmux-owned shortcuts require a modifier on the first stroke to avoid
    ...
    public var displayName: String {
        ...
        case .quit: return "Quit zerocmux"
