...
/// A strongly-typed handle to a setting persisted in the zerocmux JSON config file.
///
...
public struct JSONKey<Value: SettingCodable>: Sendable, Equatable {
    /// The dotted identifier (also the JSON path inside the zerocmux config file).
