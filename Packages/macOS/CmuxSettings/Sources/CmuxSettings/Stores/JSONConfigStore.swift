...
/// Typed read/write/observe access to settings persisted in the zerocmux JSON config file.
///
...
public actor JSONConfigStore {
    ...
    ///     ``CmuxConfigLocation/userConfigFile`` for the standard zerocmux path.
