...
/// Foundation's localization machinery reads at process start. zerocmux writes a
...
/// ``AppLanguage/system`` removes only an override zerocmux still owns. Launch
/// reconciliation repairs missing or stale zerocmux overrides for explicit
