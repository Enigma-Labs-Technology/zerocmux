...
struct BrowserSearchSettingsStoreTests {
    ...
    @Test func validatesAndRendersSearchURLTemplates() throws {
        ...
        #expect(placeholderURL.absoluteString.contains("src=zerocmux"))
        #expect(appendedURL.absoluteString.contains("source=zerocmux"))
        ...
        #expect(!store.isValidSearchURLTemplate("zerocmux://search?q={query}"))
