        ...
        let snapshot = CmuxSidebarSnapshot(
            ...
            workspaces: [
                CmuxSidebarWorkspace(
                    ...
                    listeningPorts: [3000],
                    pullRequestURLs: ["https://github.com/kernelalex/zerocmux/pull/1"]
                ),
            ]
        )
        ...
        let snapshot = CmuxSidebarSnapshot(
            ...
            workspaces: [
                CmuxSidebarWorkspace(
                    ...
                    pullRequestURLs: ["https://github.com/kernelalex/zerocmux/pull/4994"]
                ),
            ]
        )
        ...
        let snapshot = CmuxSidebarSnapshot(
            ...
            workspaces: [
                CmuxSidebarWorkspace(
                    ...
                    detail: "Running tests",
                    isPinned: true,
                    rootPath: "/tmp/zerocmux",
                    projectRootPath: "/tmp/zerocmux",
                    gitBranch: "feature/sidebar",
                    unreadCount: 2,
