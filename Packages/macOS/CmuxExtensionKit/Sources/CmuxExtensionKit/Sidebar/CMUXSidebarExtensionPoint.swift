...
public enum CmuxSidebarExtensionPoint {
    ...
    /// per build tag (e.g. `com.kernelalex.zerocmux.debug.my-tag.cmux.sidebar`) so that concurrent debug
    ...
    /// committed to source.
    public static let baseIdentifier = "com.kernelalex.zerocmux.cmux.sidebar"
    ...
    /// Default ExtensionKit scene identifier hosted inside the zerocmux sidebar.
