...
Internal zerocmux-owned sidebar provider/render models live in `Packages/macOS/CmuxSidebarProviderKit`.
...
4. Keep the extension point identifier as `com.kernelalex.zerocmux.cmux.sidebar`.
...
<dict>
  ...
  <string>com.kernelalex.zerocmux.cmux.sidebar</string>
</dict>
```
