...
The zerocmux control-socket domain: the listener and the transport/policy layer under the Unix-domain socket that external programs (the zerocmux CLI, agents, tests) use to drive the app.
