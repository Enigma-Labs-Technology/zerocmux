...
// (https://github.com/kernelalex/zerocmux/issues/5734). Faithful lift; the
...
extension RemoteSessionCoordinator {
    ...
    /// (https://github.com/kernelalex/zerocmux/issues/5734).
    ...
    /// (sidebar button, workspace context menu, `zerocmux workspace reconnect`,
