...
zerocmux new-split down --command "npm run dev"
zerocmux new-pane --type terminal --direction right --command "tail -f logs/dev.log"
zerocmux new-surface --type terminal --pane pane:1
zerocmux new-surface --type terminal --pane pane:1 --working-directory "$PWD" --command "npm test"
