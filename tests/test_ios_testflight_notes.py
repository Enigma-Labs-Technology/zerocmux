...
def main():
    ...
    with tempfile.TemporaryDirectory() as repo:
        ...
        _commit(repo, "ios/zerocmux/App.swift", "ios: fix the thing (#101)")
        ...
        _commit(repo, "ios/zerocmux/Chore.swift", "chore: bump deps (#105)")
        _commit(repo, "ios/zerocmux/Ci.swift", "ci: tweak workflow (#106)")
        ...
        _commit(repo, "ios/zerocmux/Pipe.swift", "ios: support A|B mode (#107)")
        _commit(repo, "ios/zerocmux/Pipe2.swift", "ios: support A (#108)")
        ...
        _commit(repo, "ios/zerocmux/Side.swift", "ios: side-branch only change (#900)")
