...
When a zerocmux shell leaves a git repository for a non-git directory, an async
...
def _run_case(
    ...
    *,
    ...
    socket_path = base / shell / "zerocmux.sock"
...
def _run_same_repo_case(
    ...
    *,
    ...
    socket_path = base / f"{shell}-samerepo" / "zerocmux.sock"
