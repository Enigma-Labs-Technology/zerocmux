#!/usr/bin/env python3
"""
Regression coverage for bash job-control noise from zerocmux shell integration.
...
def test_bash_integration_does_not_emit_done_notifications() -> None:
    ...
    integration_script = repo_root / "Resources/shell-integration/zerocmux-bash-integration.bash"

    with tempfile.TemporaryDirectory() as tmp:
        tmp_path = Path(tmp)
        socket_path = tmp_path / "zerocmux.sock"
