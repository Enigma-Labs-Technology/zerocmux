#!/usr/bin/env python3
"""
Regression test: `zerocmux omc` preserves fallback provider dirs in PATH.
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="zerocmux-omc-fallback-path-") as td:
        root = Path(td)
...
""",
        ...
        if proc.returncode != 0:
            print("FAIL: `zerocmux omc --version` failed with omc in a fallback dir")
    ...
    print("PASS: zerocmux omc preserves fallback provider dirs in PATH")
    return 0
