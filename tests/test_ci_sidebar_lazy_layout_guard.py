...
Verifies the guard reports "ok" on the real zerocmux repo and correctly *fails* on
...
Cases:
  (a) Real zerocmux repo passes (Sources/ContentView.swift).
...
def main():
    ...
    with tempfile.TemporaryDirectory() as workdir:
        ...
        # (i) Custom-Layout discovery must cover repo-owned Packages/ (where zerocmux
