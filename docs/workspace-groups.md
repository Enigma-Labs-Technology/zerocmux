...
zerocmux workspace-group create --name "manaflow" [--cwd ~/projects/manaflow] [--from <id>,<id>] [--idempotency-key <key>]
zerocmux workspace-group ungroup <group-id> [--remove-generated-anchor]
zerocmux workspace-group delete <group-id>                         # dissolve; keep workspaces
zerocmux workspace-group delete <group-id> --close-workspaces      # explicitly destructive
