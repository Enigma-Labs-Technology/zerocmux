...
final class DisplayResolutionRegressionUITests: XCTestCase {
    private let defaultDisplayHarnessManifestPath = "/tmp/zerocmux-ui-test-display-harness.json"
    ...
    private let prelaunchManifestPath = "/tmp/zerocmux-ui-test-prelaunch.json"
    ...
    private func resolveAppBinaryPath() throws -> String {
        ...
        //   .../Build/Products/Debug/zerocmux DEV.app/Contents/MacOS/zerocmux DEV
        ...
        let binaryPath = productsDir
            .appendingPathComponent("zerocmux DEV.app")
            .appendingPathComponent("Contents/MacOS/zerocmux DEV")
            .path
