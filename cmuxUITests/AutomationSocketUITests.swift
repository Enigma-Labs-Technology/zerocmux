...
final class AutomationSocketUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        diagnosticsPath = "/tmp/zerocmux-ui-test-automation-socket-\(UUID().uuidString).json"
    ...
    private func makeSkillFixtureRoot(skillNames: [String]) throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-ui-textbox-skills-\(UUID().uuidString)", isDirectory: true)
