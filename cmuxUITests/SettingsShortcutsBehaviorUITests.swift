...
final class SettingsShortcutsBehaviorUITests: SettingsUITestCase {
    ...
    ///   - off: "Turn this on to show or hide all zerocmux windows from any app."
    ///   - on:  "Press the shortcut from any app to show or hide all zerocmux windows."
    ...
    func testEnableToggleSwapsSubtitleCopy() {
        ...
        let offSubtitle = "Turn this on to show or hide all zerocmux windows from any app."
        let onSubtitle = "Press the shortcut from any app to show or hide all zerocmux windows."
...
//   chord shows/hides all zerocmux windows from any app. That registration and
...
//   the zerocmux UI surface to assert against. Not e2e-testable from XCUITest;
