...
struct WindowTitleTemplateTests {
    ...
    @Test func resolvesWindowPlaceholdersAndPreservesUnknownPlaceholders() throws {
        ...
        let template = WindowTitleTemplate(
            rawValue: "[zerocmux:{windowToken}] {activeWorkspace} {activeDirectory} {windowId} {defaultTitle} {appName} {unknown}"
        )
        ...
        #expect(resolved == "[zerocmux:01234567] Build /tmp/project 01234567-89ab-cdef-0123-456789abcdef Fallback zerocmux {unknown}")
    }
    ...
    @Test func resolverDoesNotExpandPlaceholdersInsideReplacementValues() throws {
        ...
        #expect(resolved == "{windowId} zerocmux")
    }
    ...
    @Test func settingsFileStoreAppliesAppWindowTitleTemplate() throws {
        ...
        let directoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-window-title-template-\(UUID().uuidString)", isDirectory: true)
        ...
        #expect(defaults.string(forKey: WindowTitleTemplate.userDefaultsKey) == "[zerocmux:{windowToken}] {activeWorkspace}")
    }
    ...
    @Test func settingsFileStoreAppliesWorkspaceAutoNamingAutomationSetting() throws {
        ...
        let directoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-workspace-auto-naming-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: directoryURL, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: directoryURL) }
    ...
    @Test func settingsFileStoreAppliesAutoNamingAgentAutomationSetting() throws {
        ...
        let directoryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-auto-naming-agent-\(UUID().uuidString)", isDirectory: true)
        try FileManager.default.createDirectory(at: directoryURL, withIntermediateDirectories: true)
        defer { try? FileManager.default.removeItem(at: directoryURL) }
    ...
    @Test func selectedWorkspaceDirectoryChangeRefreshesActiveDirectoryTitle() throws {
        ...
        defaults.set("[zerocmux:{windowToken}] {activeDirectory}", forKey: WindowTitleTemplate.userDefaultsKey)
        ...
        #expect(window.title == "[zerocmux:01234567] /tmp/old")
        ...
        #expect(window.title == "[zerocmux:01234567] /tmp/new")
    }
