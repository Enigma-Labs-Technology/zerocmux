...
struct BrowserHiddenWebViewDiscardMediaPlaybackTests {
    /// Regression coverage for https://github.com/kernelalex/zerocmux/issues/5409:
    ...
    /// so the memory bound from https://github.com/kernelalex/zerocmux/issues/4539
    /// is preserved.
...
final class BrowserHiddenWebViewDiscardManagerTests: XCTestCase {
    ...
    // Regression coverage for https://github.com/kernelalex/zerocmux/issues/5261:
...
final class BrowserPanelInitialNavigationTests: XCTestCase {
    ...
    func testDiffViewerURLIsNotPersistedForSessionRestore() throws {
        ...
        let loopbackURL = try XCTUnwrap(URL(string: "http://127.0.0.1:49152/token/diff.html#zerocmux-diff-viewer"))
        ...
        let aliasURL = try XCTUnwrap(URL(string: "http://cmux-loopback.localtest.me:49152/token/diff.html#zerocmux-diff-viewer"))
    ...
    func testDiffViewerURLIsNotRecordedInBrowserHistory() throws {
        let fileURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-browser-history-\(UUID().uuidString).json")
...
final class BrowserPanelDiffViewerSchemeTests: XCTestCase {
    ...
    func testDiffViewerSchemeRejectsSymlinkEscapeFromTrustedRoot() throws {
        ...
        let temporaryURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-diff-viewer-security-\(UUID().uuidString)", isDirectory: true)
...
final class BrowserWindowPortalLifecycleTests: XCTestCase {
    ...
    // Regression guard for https://github.com/kernelalex/zerocmux/issues/5733.
    ...
    // Crash regression for https://github.com/kernelalex/zerocmux/issues/5733.
    //
...
final class OmnibarNativeTextFieldCaretTests: XCTestCase {
    ...
    private func installOmnibarField(
        in window: NSWindow,
        stringValue: String = "https://github.com/kernelalex/zerocmux"
    ...
    /// Regression for https://github.com/kernelalex/zerocmux/issues/5268: a single,
