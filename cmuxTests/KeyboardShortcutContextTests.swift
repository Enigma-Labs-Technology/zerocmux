...
final class KeyboardShortcutContextTests: XCTestCase {
    ...
    // still match from those keys. See https://github.com/kernelalex/zerocmux/pull/5163.
    ...
    private func makeTemporaryDirectory() throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-shortcut-context-\(UUID().uuidString)", isDirectory: true)
