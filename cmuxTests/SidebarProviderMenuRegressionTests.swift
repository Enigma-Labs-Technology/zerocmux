...
/// its views disappeared (https://github.com/kernelalex/zerocmux/issues/5173).
///
...
struct SidebarProviderMenuRegressionTests {
    ...
    func customSidebarFileURLRejectsPathTraversalProviderIds() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-custom-sidebar-test-\(UUID().uuidString)", isDirectory: true)
