...
struct AboutLicensesResourceTests {
    ...
    @Test(
        ...
        arguments: ["com.kernelalex.zerocmux.debug.licpkg", "com.kernelalex.zerocmux.nightly"]
    )
    func nonStableBuildUsesCommit(bundleIdentifier: String) {
        ...
        #expect(url.absoluteString == "https://github.com/Enigma-Labs-Technology/zerocmux/tree/abcdef123")
    }
}
