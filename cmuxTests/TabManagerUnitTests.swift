...
final class TabManagerCloseCurrentPanelTests: XCTestCase {
    ...
    private func withWarnBeforeClosingTabConfig(
        ...
        let originalImportedManagedDefaults = defaults.object(forKey: importedManagedDefaultsKey)
        defaults.removeObject(forKey: CloseTabWarningSettings.warnBeforeClosingTabKey)
        ...
        defer {
            ...
            if let originalImportedManagedDefaults {
                defaults.set(originalImportedManagedDefaults, forKey: importedManagedDefaultsKey)
            } else {
                defaults.removeObject(forKey: importedManagedDefaultsKey)
            }
        }
