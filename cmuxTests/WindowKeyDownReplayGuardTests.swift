...
/// Regression coverage for https://github.com/kernelalex/zerocmux/issues/5887.
///
...
struct WindowKeyDownReplayGuardTests {
    ...
    /// https://github.com/kernelalex/zerocmux/issues/5887 crash looped through.
    ...
    func printableOptionTextKeyDownIsForceDispatchedExactlyOncePerEvent() {
        ...
        #expect(
            ...
            Comment(rawValue: "The same in-flight key event must not be force-dispatched into keyDown again while the first dispatch is still on the stack; unbounded re-dispatch is the infinite key-routing loop from https://github.com/kernelalex/zerocmux/issues/5887")
        )
    }
