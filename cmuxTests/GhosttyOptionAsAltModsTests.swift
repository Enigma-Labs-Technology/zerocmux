...
/// Regression coverage for https://github.com/kernelalex/zerocmux/issues/5993:
/// zerocmux ignored `macos-option-as-alt` left/right and captured Option before
...
/// zerocmux sends. If zerocmux maps both physical Option keys to the same generic
