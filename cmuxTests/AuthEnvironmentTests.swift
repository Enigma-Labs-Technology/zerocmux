...
struct AuthEnvironmentTests {
    ...
    func debugCallbackSchemeUsesSanitizedTag() {
        #expect(
            AuthEnvironment.callbackScheme(
                ...
                bundleIdentifier: "com.kernelalex.zerocmux.debug.safari-auth",
                isDebugBuild: true
            ) == "zerocmux-dev-safari-auth"
        )
    }
    ...
    func signInURLEntersNativeWrapper() {
        ...
        let url = AuthEnvironment.signInURL(
            ...
            environment: [
                ...
                "CMUX_AUTH_CALLBACK_SCHEME": "zerocmux",
            ],
            bundleIdentifier: "com.kernelalex.zerocmux"
        )
    ...
    func taggedDebugSignInURLUsesLocalOriginAndTagCallbackScheme() throws {
        let url = AuthEnvironment.signInURL(
            ...
            bundleIdentifier: "com.kernelalex.zerocmux.debug.pair-auth"
        )
        ...
        #expect(nativeCallbackURL.scheme == "zerocmux-dev-pair-auth")
...
private func assertNativeSignInURL(_ url: URL) {
    ...
    #expect(nativeCallbackURL.scheme == "zerocmux")
    #expect(nativeCallbackURL.host == "auth-callback")
