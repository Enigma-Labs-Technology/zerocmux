    ...
    func testBundleIconPersistenceAllowsStableReleaseBundle() {
        XCTAssertTrue(
            AppBundleIconPersistencePolicy.shouldPersist(
                ...
                appBundleLastPathComponent: "zerocmux.app",
    ...
    func testBundleIconPersistenceSkipsNightlyBundles() {
        XCTAssertFalse(
            AppBundleIconPersistencePolicy.shouldPersist(
                ...
                appBundleLastPathComponent: "zerocmux NIGHTLY.app",
                persistenceDisabled: false
            )
        )
        XCTAssertFalse(
            AppBundleIconPersistencePolicy.shouldPersist(
                bundleIdentifier: "com.kernelalex.zerocmux.nightly.issue-4350",
                appBundleLastPathComponent: "zerocmux NIGHTLY issue-4350.app",
                persistenceDisabled: false
            )
        )
    }
    ...
    func testBundleIconPersistenceSkipsDebugBundles() {
        XCTAssertFalse(
            AppBundleIconPersistencePolicy.shouldPersist(
                ...
                appBundleLastPathComponent: "zerocmux DEV.app",
                persistenceDisabled: false
            )
        )
        XCTAssertFalse(
            AppBundleIconPersistencePolicy.shouldPersist(
                bundleIdentifier: "com.kernelalex.zerocmux.debug.issue-4350",
                appBundleLastPathComponent: "zerocmux DEV issue-4350.app",
                persistenceDisabled: false
            )
        )
    }
