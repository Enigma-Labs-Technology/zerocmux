...
// compiled into both the `zerocmux-cli` target and this test target — so the pure
...
///
/// https://github.com/kernelalex/zerocmux/issues/4985
...
struct FeedEventClassificationTests {
    ...
    /// telemetry. Otherwise "Approve for me" gets bypassed by zerocmux's Feed UI.
