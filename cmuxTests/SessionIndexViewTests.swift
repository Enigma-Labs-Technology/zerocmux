...
final class SessionIndexViewTests: XCTestCase {
    ...
    func testClaudeResumeCommandPinsSnapshotConfigDirectory() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-session-index-\(UUID().uuidString)", isDirectory: true)
    ...
    // Regression for https://github.com/kernelalex/zerocmux/issues/5262.
    // zerocmux captures Codex's *internal* sandbox-policy `type`, which is a superset of
    ...
    func testCodexResumeCommandReproducesBypassFlagForDisabledSandbox() {
        ...
        // The codex resume now routes the codex executable through the zerocmux codex
    ...
    func testCodexSQLSearchMatchesRolloutTranscriptContent() async throws {
        ...
        {"timestamp":"2026-05-01T09:01:00.000Z","type":"response_item","payload":{"type":"function_call","name":"exec_command","arguments":"{\\"cmd\\":\\"tail -n 80 /tmp/zerocmux-debug-task-activation-performance-harness.log\\"}","call_id":"call_1"}}
        """
        ...
        let outcome = await SessionIndexStore.loadCodexEntriesForTesting(
            ...
            needle: "/tmp/zerocmux-debug-task-activation-performance-harness.log",
            offset: 0,
            limit: 10,
    ...
    // Regression for https://github.com/kernelalex/zerocmux/issues/6302.
    ...
    /// (fish/csh/tcsh). https://github.com/kernelalex/zerocmux/issues/5639
