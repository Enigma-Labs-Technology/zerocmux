...
@Suite struct BrowserHistorySuggestionCacheTests {
    private func makeStore() -> (store: BrowserHistoryStore, fileURL: URL) {
        let fileURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-history-suggest-\(UUID().uuidString).json")
    ...
    @Test func suggestionsMatchHostAndTitleAfterCaching() {
        ...
        store.recordVisit(url: URL(string: "https://github.com/kernelalex/zerocmux/issues"), title: "zerocmux issues")
        ...
        #expect(results.contains("https://github.com/kernelalex/zerocmux/issues"))
