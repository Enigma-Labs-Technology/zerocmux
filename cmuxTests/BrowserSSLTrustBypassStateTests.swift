...
struct BrowserSSLTrustBypassStateTests {
    ...
    func errorPageRetryURLAllowsOnlyWebURLs() throws {
        ...
        #expect(BrowserErrorPage.retryURL(from: "zerocmux-browser-action://bypass-ssl?token=abc") == nil)
    ...
    func pendingBypassReplaysOriginalRequestOnceAndMarksHostBypassed() throws {
        ...
        #expect(actionURL.scheme == "zerocmux-browser-action")
    ...
    func pendingBypassRejectsMissingForgedAndExpiredTokens() throws {
        ...
        let missingTokenURL = try #require(URL(string: "zerocmux-browser-action://bypass-ssl"))
        let forgedTokenURL = try #require(URL(string: "zerocmux-browser-action://bypass-ssl?token=not-issued"))
