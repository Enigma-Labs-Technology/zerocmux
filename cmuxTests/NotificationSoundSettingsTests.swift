...
@Suite struct NotificationSoundSettingsTests {
    ...
    @Test func activeFocusAssertionSuppressesFallbackSound() throws {
        ...
        let directory = fileManager.temporaryDirectory
            .appendingPathComponent("zerocmux-dnd-\(UUID().uuidString)", isDirectory: true)
    ...
    @Test func missingAssertionStoreFailsOpen() {
        let missing = FileManager.default.temporaryDirectory
            .appendingPathComponent("zerocmux-dnd-missing-\(UUID().uuidString)", isDirectory: true)
    ...
    // will not deliver the banner. A user who explicitly denied zerocmux
...
private struct ActiveFocusFixture {
    ...
    init(createAssertionsFile: Bool = true) throws {
        ...
        directory = fileManager.temporaryDirectory
            .appendingPathComponent("zerocmux-dnd-play-\(UUID().uuidString)", isDirectory: true)
        try fileManager.createDirectory(at: directory, withIntermediateDirectories: true)
        ...
        suiteName = "zerocmux-tests-notification-sound-\(UUID().uuidString)"
