...
final class BuildFlavorTests: XCTestCase {
    func testDetectsDevFromBundleName() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "zerocmux DEV noqdlg", bundleIdentifier: "com.kernelalex.zerocmux"),
            .dev
        )
    }
    ...
    func testDetectsDevBeforeTagTextCanLookNightly() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "zerocmux DEV nightly", bundleIdentifier: "com.kernelalex.zerocmux"),
            .dev
        )
    }
    ...
    func testDetectsNightlyFromBundleIdentifier() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "zerocmux", bundleIdentifier: "com.kernelalex.zerocmux.nightly"),
            .nightly
        )
    }
    ...
    func testDetectsStableByDefault() {
        XCTAssertEqual(
            BuildFlavor.detect(bundleName: "zerocmux", bundleIdentifier: "com.kernelalex.zerocmux"),
            .stable
        )
    }
}
