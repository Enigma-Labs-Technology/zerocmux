...
@MainActor final class CommandPaletteKeyboardNavigationTests: XCTestCase {
    override func setUp() {
        ...
        KeyboardShortcutSettings.setShortcutOverrideForTesting(
            ...
            for: .commandPalettePrevious
        )
    }

    override func tearDown() {
        KeyboardShortcutSettings.setShortcutOverrideForTesting(nil, for: .commandPaletteNext)
        KeyboardShortcutSettings.setShortcutOverrideForTesting(nil, for: .commandPalettePrevious)
        super.tearDown()
    }
