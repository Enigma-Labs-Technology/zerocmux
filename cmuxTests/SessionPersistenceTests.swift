...
final class SocketListenerAcceptPolicyTests: XCTestCase {
    ...
    func testCodexTeamsResumeCommandUsesWrapperSubcommand() {
        ...
        XCTAssertEqual(
            snapshot.resumeCommand,
            "cd -- '/Users/example/repo' 2>/dev/null || [ ! -d '/Users/example/repo' ] && 'env' 'CODEX_HOME=/tmp/codex home' '/usr/local/bin/zerocmux' 'codex-teams' 'resume' '019dad34-d218-7943-b81a-eddac5c87951' '--model' 'gpt-5.4' '--sandbox' 'danger-full-access'"
        )
    }
    ...
    func testCodexTeamsResumeCommandDropsOriginalForkTarget() {
        ...
        XCTAssertEqual(
            snapshot.resumeCommand,
            "cd -- '/Users/example/repo' 2>/dev/null || [ ! -d '/Users/example/repo' ] && 'env' 'CODEX_HOME=/tmp/codex home' '/usr/local/bin/zerocmux' 'codex-teams' 'resume' '019dad34-d218-7943-b81a-eddac5c87952' '--model' 'gpt-5.4' '--sandbox' 'danger-full-access'"
        )
    }
