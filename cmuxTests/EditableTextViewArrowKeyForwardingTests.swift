...
/// Regression coverage for https://github.com/kernelalex/zerocmux/issues/5227.
///
/// In a zerocmux window every keyDown is funneled through the swizzled
...
struct EditableTextViewArrowKeyForwardingTests {
    ...
    func doesNotStealCommandOptionArrowFromPaneFocusShortcut(keyCode: UInt16) {
        // Cmd+Option+Arrow is reserved for zerocmux pane-focus shortcuts and must
