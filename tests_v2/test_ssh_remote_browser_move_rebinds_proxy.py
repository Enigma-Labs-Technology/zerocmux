...
SOCKET_PATH = os.environ.get("CMUX_SOCKET_PATH", "/tmp/zerocmux.sock")
    ...
    try:
        with cmux(SOCKET_PATH) as client:
            ...
            server_script = (
                ...
                f"python3 -m http.server {ssh_web_port} --directory /tmp >/tmp/zerocmux-remote-browser-proxy-{stamp}.log 2>&1 & "
