...
extension CMUXCLI {
    ...
    static let agentDefs: [AgentHookDef] = [
        AgentHookDef(
            ...
            hookMarker: "zerocmux hooks codex", format: .nested(timeoutMs: agentHookDeclaredTimeoutMilliseconds),
            events: [
        ...
        AgentHookDef(
            ...
            configDir: ".campfire/agent", configFile: "extensions/zerocmux-campfire-session.ts",
            createConfigDirIfMissing: true,
            ...
            hookMarker: "zerocmux hooks campfire", format: .flat,
            events: []
        ),
        AgentHookDef(
        ...
        AgentHookDef(
            ...
            hookMarker: "zerocmux hooks kimi", format: .tomlArrayTable,
            events: [
                .init(agentEvent: "SessionStart", cmuxSubcommand: "session-start"),
                .init(agentEvent: "UserPromptSubmit", cmuxSubcommand: "prompt-submit"),
                .init(agentEvent: "Notification", cmuxSubcommand: "notification"),
