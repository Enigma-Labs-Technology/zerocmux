    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text(String(
                ...
                defaultValue: "Keep this app installed. In zerocmux, open Sidebar Extensions, enable CMUX Sample Sidebar Extension, choose it from the sidebar picker, and confirm Workspace Signals shows your real workspaces."
            ))
