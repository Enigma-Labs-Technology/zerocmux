# zerocmux terminfo overlay

zerocmux ships patched `xterm-ghostty` and `xterm-256color` terminfo entries so
...
zerocmux while preserving Ghostty's truecolor capabilities.
